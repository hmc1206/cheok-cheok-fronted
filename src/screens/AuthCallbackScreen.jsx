...
export function AuthCallbackScreen() {
  ...
  return <AppFrame><main className="salad-auth flex h-full min-h-0 flex-col bg-white px-6 py-6"><header className="flex items-center gap-2"><span className="salad-login__mark flex h-9 w-9 items-center justify-center"><img src="/manus-storage/cheok-logo-mark_977663d4.png" alt="척척 로고" className="h-5 w-5" /></span><span className="text-[19px] font-bold tracking-[-0.05em] text-[#111]">척척</span></header><section className="my-auto"><span className="salad-auth__loader block h-12 w-12 rounded-full" /><p className="mt-7 text-[15px] font-bold text-[var(--cb-tomato)]">안전하게 연결하고 있어요</p><h1 className="mt-2 text-[33px] font-bold leading-[1.27] tracking-[-0.06em] text-[#111]">로그인 정보를<br />확인하는 중입니다.</h1><p className="mt-4 text-[16px] font-medium leading-7 text-[#555c68]">잠시만 기다리면 바로 척척을 시작할 수 있어요.</p></section><p className="border-t border-[#f0f2f5] pt-5 text-[14px] font-medium text-[#9fa4b0]">로그인 세션을 확인하고 있어요.</p></main></AppFrame>
}
