  ...
  return (
    <main className="flex flex-col gap-4 p-6 pb-40">
      ...
      <div className="grid grid-cols-2 gap-2">
        <button type="button" className="quick-action-button" onClick={() => handleControl('PAUSE')}>
          일시정지
        </button>
        <button type="button" className="quick-action-button" onClick={() => handleControl('RESUME')}>
          다시재생
        </button>
        <button type="button" className="quick-action-button" onClick={() => handleControl('NEXT')}>
          다음영상
        </button>
        <button
          type="button"
