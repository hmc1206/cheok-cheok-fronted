...
// on/off, 다른 화면인 /notification-settings 전용)와는 별개의 토글 3개라 여기서
// 새로 mock을 만든다 — 백엔드 확정 전까지 모듈 스코프 변수로만 상태를 유지하고,
// 실제 엔드포인트가 정해지면 이 파일 내부 구현만 교체하면 되도록 반환 형태
// { voiceGuidance, sensitiveActionAlert, adViewAlert }만 먼저 잡아둔다.
let mockSettings = {
