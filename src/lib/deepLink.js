// 백엔드(/voice/process, /api/v1/youtube/link, /api/v1/routes/naver-link)가 이미
// 완성해서 준 앱/웹 URL로 딥링크를 실행한다. URL 조립은 프론트에서 하지 않는다 — 유튜브
// 딥링크, 네이버 지도 딥링크 등 어떤 app_url/web_url 쌍에도 그대로 재사용 가능한 공용 버전.
 ...
 * 표준적인 방식이다.)
 */
export function openDeepLinkWithWebFallback(appUrl, webUrl, { fallbackDelayMs = 1500 } = {}) {
  let didHide = false
